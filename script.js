var SpaceInvaders = function(selector, mode, rows, cols, hSteps, vSteps, bulletsNumber)
{
    ...
    $game.html('<ul class="object aliens"></ul>' +
        ...
        '<div class="object win">SHE WILL GET YOU NEXT TIME</div>' +
        '<div class="object lose">YOU JUST GOT HUGGED</div>' +
...
$(document).ready(function() {                            
    ...
    var game = new SpaceInvaders('.game', 'manual', 3, 3, 2, 4, 15);        
